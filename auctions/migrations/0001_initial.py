...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_on_watch', to='auctions.listing')),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('publisher', 'listing')},
            },
        ),
        migrations.CreateModel(
            name='Bid',
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_on_bid', to='auctions.listing')),
            ],
            options={
